...
public class HttpUtil {
     ...
     * @return URL 所代表远程资源的响应结果
     */
    public static String BlockGet(String url) {
        String result = "";
        BufferedReader in = null;
        try {
            String strurl = url;
    ...
    public static String getHttpPost(String rul , String bodys) throws IOException {
        Request request = Request.Post(rul);
        //String body = "{\"row\": 1,\"page\":0}";
        request.bodyString(bodys, ContentType.APPLICATION_JSON);
